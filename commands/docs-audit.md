---
description: Audit this repo's AI-facing docs (AGENTS.md/CLAUDE.md/docs) and emit a scored, prioritized report
...
Scope: $ARGUMENTS (if empty, audit the whole repo — root and nested `AGENTS.md`,
`CLAUDE.md`, and `docs/`). Run the gate in read-only/report mode, read the docs
