...
name: docs-audit
description: >
  Audit a repository's existing AI-facing docs (CLAUDE.md, architecture/
...
it against the repo.) `size_check` over/near the verbosity budget is a top-severity
finding.
...
|---|---|
| Always-loaded file small, within the verbosity budget | AP-2 oversized |
